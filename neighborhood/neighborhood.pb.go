...
func (x *NeighborhoodBrief) Reset() {
	*x = NeighborhoodBrief{}
	if protoimpl.UnsafeEnabled {
...
func (x *NeighborhoodBrief) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NeighborhoodBrief) ProtoMessage() {}

func (x *NeighborhoodBrief) ProtoReflect() protoreflect.Message {
	mi := &file_neighborhood_neighborhood_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NeighborhoodBrief.ProtoReflect.Descriptor instead.
func (*NeighborhoodBrief) Descriptor() ([]byte, []int) {
	return file_neighborhood_neighborhood_proto_rawDescGZIP(), []int{2}
}

func (x *NeighborhoodBrief) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *NeighborhoodBrief) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *NeighborhoodBrief) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ResponseList) Reset() {
	*x = ResponseList{}
	if protoimpl.UnsafeEnabled {
		mi := &file_neighborhood_neighborhood_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ResponseList) Descriptor() ([]byte, []int) {
	return file_neighborhood_neighborhood_proto_rawDescGZIP(), []int{12}
}
...
type RequestCityNeighborhoodsList struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// @inject_tag: json:"provinceId",validate:"alphanum,required"
	CityId string `protobuf:"bytes,1,opt,name=cityId,proto3" json:"provinceId" validate:"alphanum,required"`
}

func (x *RequestCityNeighborhoodsList) Reset() {
	*x = RequestCityNeighborhoodsList{}
	if protoimpl.UnsafeEnabled {
		mi := &file_neighborhood_neighborhood_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RequestCityNeighborhoodsList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RequestCityNeighborhoodsList) ProtoMessage() {}

func (x *RequestCityNeighborhoodsList) ProtoReflect() protoreflect.Message {
	mi := &file_neighborhood_neighborhood_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RequestCityNeighborhoodsList.ProtoReflect.Descriptor instead.
func (*RequestCityNeighborhoodsList) Descriptor() ([]byte, []int) {
	return file_neighborhood_neighborhood_proto_rawDescGZIP(), []int{13}
}

func (x *RequestCityNeighborhoodsList) GetCityId() string {
	if x != nil {
		return x.CityId
	}
	return ""
...
type ResponseCityNeighborhoodsList struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Neighborhoods []*NeighborhoodBrief `protobuf:"bytes,1,rep,name=neighborhoods,proto3" json:"neighborhoods,omitempty"`
}

func (x *ResponseCityNeighborhoodsList) Reset() {
	*x = ResponseCityNeighborhoodsList{}
	if protoimpl.UnsafeEnabled {
		mi := &file_neighborhood_neighborhood_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ResponseCityNeighborhoodsList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResponseCityNeighborhoodsList) ProtoMessage() {}

func (x *ResponseCityNeighborhoodsList) ProtoReflect() protoreflect.Message {
	mi := &file_neighborhood_neighborhood_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResponseCityNeighborhoodsList.ProtoReflect.Descriptor instead.
func (*ResponseCityNeighborhoodsList) Descriptor() ([]byte, []int) {
	return file_neighborhood_neighborhood_proto_rawDescGZIP(), []int{14}
}

func (x *ResponseCityNeighborhoodsList) GetNeighborhoods() []*NeighborhoodBrief {
	if x != nil {
		return x.Neighborhoods
	}
	return nil
...
var file_neighborhood_neighborhood_proto_rawDesc = []byte{
	...
	0x22, 0x4d, 0x0a, 0x11, 0x4e, 0x65, 0x69, 0x67, 0x68, 0x62, 0x6f, 0x72, 0x68, 0x6f, 0x6f, 0x64,
	...
	0x40, 0x0a, 0x04, 0x41, 0x72, 0x65, 0x61, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	...
	0x65, 0x22, 0x20, 0x0a, 0x0e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x44, 0x65, 0x74, 0x61,
	0x69, 0x6c, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x02, 0x69, 0x64, 0x22, 0x7b, 0x0a, 0x0f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x44,
	0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x3e, 0x0a, 0x0c, 0x6e, 0x65, 0x69, 0x67, 0x68, 0x62,
	0x6f, 0x72, 0x68, 0x6f, 0x6f, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6e,
	...
	,
	...
	0x69, 0x74, 0x79, 0x49, 0x64, 0x12, 0x3e, 0x0a, 0x0c, 0x6e, 0x65, 0x69, 0x67, 0x68, 0x62, 0x6f,
	...
	,
	...
	0x3a, 0x0a, 0x1e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x43, 0x68, 0x65, 0x63, 0x6b,
	0x56, 0x61, 0x6c, 0x69, 0x64, 0x4e, 0x65, 0x69, 0x67, 0x68, 0x62, 0x6f, 0x72, 0x68, 0x6f, 0x6f,
	0x64, 0x12, 0x18, 0x0a, 0x07, 0x69, 0x73, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x22, 0x37, 0x0a, 0x0b, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f,
	...
	,
...
var file_neighborhood_neighborhood_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_neighborhood_neighborhood_proto_goTypes = []interface{}{
	...
	(*NeighborhoodBrief)(nil),                       // 2: neighborhood.NeighborhoodBrief
	(*Area)(nil),                                    // 3: neighborhood.Area
	(*RequestDetails)(nil),                          // 4: neighborhood.RequestDetails
	(*ResponseDetails)(nil),                         // 5: neighborhood.ResponseDetails
	(*RequestCreate)(nil),                           // 6: neighborhood.RequestCreate
	(*RequestCheckExistByProvinceIdAndCityId)(nil),  // 7: neighborhood.RequestCheckExistByProvinceIdAndCityId
	(*ResponseCheckExistByProvinceIdAndCityId)(nil), // 8: neighborhood.ResponseCheckExistByProvinceIdAndCityId
	(*RequestCheckValidNeighborhood)(nil),           // 9: neighborhood.RequestCheckValidNeighborhood
	(*ResponseCheckValidNeighborhood)(nil),          // 10: neighborhood.ResponseCheckValidNeighborhood
	(*RequestList)(nil),                             // 11: neighborhood.RequestList
	(*ResponseList)(nil),                            // 12: neighborhood.ResponseList
	(*RequestCityNeighborhoodsList)(nil),            // 13: neighborhood.RequestCityNeighborhoodsList
	(*ResponseCityNeighborhoodsList)(nil),           // 14: neighborhood.ResponseCityNeighborhoodsList
}
var file_neighborhood_neighborhood_proto_depIdxs = []int32{
	3,  // 0: neighborhood.NeighborhoodFull.province:type_name -> neighborhood.Area
	3,  // 1: neighborhood.NeighborhoodFull.city:type_name -> neighborhood.Area
	...
	2,  // 6: neighborhood.ResponseCityNeighborhoodsList.neighborhoods:type_name -> neighborhood.NeighborhoodBrief
	6,  // 7: neighborhood.neighborhoodService.Create:input_type -> neighborhood.RequestCreate
	7,  // 8: neighborhood.neighborhoodService.CheckExistByProvinceIdAndCityId:input_type -> neighborhood.RequestCheckExistByProvinceIdAndCityId
	9,  // 9: neighborhood.neighborhoodService.CheckValidNeighborhood:input_type -> neighborhood.RequestCheckValidNeighborhood
	11, // 10: neighborhood.neighborhoodService.list:input_type -> neighborhood.RequestList
	13, // 11: neighborhood.neighborhoodService.cityNeighborhoods:input_type -> neighborhood.RequestCityNeighborhoodsList
	5,  // 12: neighborhood.neighborhoodService.Create:output_type -> neighborhood.ResponseDetails
	8,  // 13: neighborhood.neighborhoodService.CheckExistByProvinceIdAndCityId:output_type -> neighborhood.ResponseCheckExistByProvinceIdAndCityId
	10, // 14: neighborhood.neighborhoodService.CheckValidNeighborhood:output_type -> neighborhood.ResponseCheckValidNeighborhood
	12, // 15: neighborhood.neighborhoodService.list:output_type -> neighborhood.ResponseList
	14, // 16: neighborhood.neighborhoodService.cityNeighborhoods:output_type -> neighborhood.ResponseCityNeighborhoodsList
...
func file_neighborhood_neighborhood_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_neighborhood_neighborhood_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NeighborhoodBrief); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_neighborhood_neighborhood_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_neighborhood_neighborhood_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RequestCityNeighborhoodsList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_neighborhood_neighborhood_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ResponseCityNeighborhoodsList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type NeighborhoodServiceClient interface {
	...
	CityNeighborhoods(ctx context.Context, in *RequestCityNeighborhoodsList, opts ...grpc.CallOption) (*ResponseCityNeighborhoodsList, error)
}
...
func (c *neighborhoodServiceClient) CityNeighborhoods(ctx context.Context, in *RequestCityNeighborhoodsList, opts ...grpc.CallOption) (*ResponseCityNeighborhoodsList, error) {
	out := new(ResponseCityNeighborhoodsList)
	err := c.cc.Invoke(ctx, "/neighborhood.neighborhoodService/cityNeighborhoods", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NeighborhoodServiceServer interface {
	...
	CityNeighborhoods(context.Context, *RequestCityNeighborhoodsList) (*ResponseCityNeighborhoodsList, error)
}
...
func (*UnimplementedNeighborhoodServiceServer) CityNeighborhoods(context.Context, *RequestCityNeighborhoodsList) (*ResponseCityNeighborhoodsList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CityNeighborhoods not implemented")
}
...
func _NeighborhoodService_CityNeighborhoods_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestCityNeighborhoodsList)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NeighborhoodServiceServer).CityNeighborhoods(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neighborhood.neighborhoodService/CityNeighborhoods",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NeighborhoodServiceServer).CityNeighborhoods(ctx, req.(*RequestCityNeighborhoodsList))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _NeighborhoodService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "cityNeighborhoods",
			Handler:    _NeighborhoodService_CityNeighborhoods_Handler,
		},
	},
